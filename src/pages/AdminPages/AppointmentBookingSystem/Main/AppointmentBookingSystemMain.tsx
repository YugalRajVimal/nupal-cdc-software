...
//   getTotalSessionsForPackage, getPatientDisplayName,
// } from "./types";
...
//       }
//     }
//     const booked = bookedSlotsObj[apiDate] || [];
...
//       setBookingSuccess(editBookingId ? "Booking successfully updated." : "Booking successfully created.");
//       resetForm();
//     } catch (error: any) {
...
export default function AppointmentBookingSystemMain() {
  ...
  function getTherapistAvailableSlotsForDay(dateStr: string): {
    ...
    const booked = therapist.bookedSlots?.[apiDate] || [];
