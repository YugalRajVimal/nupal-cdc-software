...
//                   </div>
//                   {typeof booking.package?.totalCost === "number" && (
//                     <div className="mb-2 px-2 py-2 rounded bg-purple-50 border border-purple-200 text-xs space-y-1">
//                       <div className="flex items-center justify-between text-purple-900">
//                         <span>Package cost</span>
//                         <span className="font-mono">₹{booking.package.totalCost}</span>
//                       </div>
//                       <div className="flex items-center justify-between text-green-700 font-semibold">
//                         <span>
//                           Overall discount{discountPercent > 0 ? ` (${discountPercent}%)` : ""}
//                         </span>
//                         <span className="font-mono">
//                           − ₹{Math.round((booking.package.totalCost * discountPercent) / 100)}
//                         </span>
//                       </div>
//                       <div className="flex items-center justify-between text-purple-900 font-semibold border-t border-purple-200 pt-1 mt-1">
//                         <span>Amount after discount</span>
//                         <span className="font-mono">
//                           ₹{booking.package.totalCost - Math.round((booking.package.totalCost * discountPercent) / 100)}
//                         </span>
//                       </div>
//                     </div>
//                   )}
