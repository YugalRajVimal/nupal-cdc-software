        ...
        {Array.from({ length: daysInMonth }).map((_, i) => {
          ...
          return (
            <div
              ...
              // Only lock out cells that have nothing selected yet — a day that
              // already has session(s) must stay interactive even at the cap,
              // otherwise the "−" remove button inside it becomes unclickable
              // (pointer-events: none on the cell disables its children too),
              // and there'd be no way to remove a session to get back under max.
              style={isAtMax && selectedCount === 0 ? { pointerEvents: "none" } : {}}
            >
