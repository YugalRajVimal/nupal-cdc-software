                ...
                <div className="flex flex-col w-full">
                  <div className="bg-slate-50 p-6 rounded-xl grid grid-cols-1 md:grid-cols-2 gap-6 text-base">
                    <div>
                      ...
                      <Detail label="Package" value={formData.package} />
                      <Detail label="Planned Sessions/Month" value={formData.plannedSessionsPerMonth} />
                    </div>
                    <div>
...
function Input({ label, as = "input", rows, ...props }: InputProps) {
  return (
